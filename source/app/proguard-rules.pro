...
-keepclassmembers class * extends itz.next_step.android.data.model.api.request.BaseRequest { *;}
-keep class com.pos.android.data.model.api.response.BaseResponse**
-keepclassmembers class * extends itz.next_step.android.data.model.api.response.BaseResponse { *;}